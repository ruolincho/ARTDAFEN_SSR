...
import { _ as _export_sfc, a2 as useNuxtApp, a3 as useUserStore, aw as useCartStore, u as useRoute, a4 as useRouter, a9 as useCurrencyStore, ac as __nuxt_component_1$2, ab as imagePrefix, a as ElButton, at as debounce, ap as useRuntimeConfig, Z as TRADE_MODULE, b as ElMessage, ax as PRODUCT_URL } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(goodsDetail).creator) {
        ...
        if ((_a = unref(goodsDetail).creator) == null ? void 0 : _a.portrait) {
          _push(`<div class="avatar" data-v-0fc991c3><img class="w-full"${ssrRenderAttr("src", unref(imagePrefix)((_b = unref(goodsDetail).creator) == null ? void 0 : _b.portrait))} alt="avatar" data-v-0fc991c3></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="info flex-1 text-gray-600" data-v-0fc991c3><p class="text-16 f-bold-500" data-v-0fc991c3>${ssrInterpolate(((_c = unref(goodsDetail).creator) == null ? void 0 : _c.timeline) || "--")}</p><p class="text-20 f-bold-500 text-gray-700 my-10" data-v-0fc991c3>${ssrInterpolate((_d = unref(goodsDetail).creator) == null ? void 0 : _d.name)}</p><p class="text-18" data-v-0fc991c3>${ssrInterpolate((_e = unref(goodsDetail).creator) == null ? void 0 : _e.intro)}</p></div></div></div></section>`);
      } else {
        _push(`<!---->`);
      }
      if ((_g = (_f = unref(goodsDetail)) == null ? void 0 : _f.details) == null ? void 0 : _g.length) {
      ...
      if ((_i = (_h = unref(goodsDetail)) == null ? void 0 : _h.brand) == null ? void 0 : _i.id) {
        _push(`<section class="mt-lg-60 mt-sm-20" data-v-0fc991c3><div class="container-middle" data-v-0fc991c3><div class="brand-topic mb-20" data-v-0fc991c3><div class="brand-topic-caption text-white text-26" data-v-0fc991c3><p data-v-0fc991c3>${ssrInterpolate((_k = (_j = unref(goodsDetail)) == null ? void 0 : _j.brand) == null ? void 0 : _k.name)}</p><p class="text-60 f-bold my-xs-20 my-15" data-v-0fc991c3>${ssrInterpolate((_m = (_l = unref(goodsDetail)) == null ? void 0 : _l.brand) == null ? void 0 : _m.title)}</p><p data-v-0fc991c3>${ssrInterpolate((_o = (_n = unref(goodsDetail)) == null ? void 0 : _n.brand) == null ? void 0 : _o.intro)}</p></div><button class="caption-btn text-28 p-xs-20 p-15" data-v-0fc991c3> Brand Home <span class="iconfont icon-right-arrow text-28 ml-xs-60 ml-30" data-v-0fc991c3></span></button><img class="w-full pc"${ssrRenderAttr("src", unref(imagePrefix)((_q = (_p = unref(goodsDetail)) == null ? void 0 : _p.brand) == null ? void 0 : _q.background))} alt="" data-v-0fc991c3><img class="w-full app"${ssrRenderAttr("src", unref(imagePrefix)((_s = (_r = unref(goodsDetail)) == null ? void 0 : _r.brand) == null ? void 0 : _s.img))} alt="" data-v-0fc991c3></div>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
        _push(`</div></section>`);
      } else {
        _push(`<!---->`);
            ...
            ssrRenderList(unref(shoppingFaq), (subItem) => {
              _push2(ssrRenderComponent(_component_el_collapse_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a2;
                  if (_push3) {
                    _push3(`<div class="px-20 py-24" data-v-0fc991c3${_scopeId2}>${(_a2 = subItem.content) != null ? _a2 : ""}</div>`);
                  } else {
                    return [
                      createVNode("div", {
                        class: "px-20 py-24",
...
//# sourceMappingURL=_id_-BFtBuFic.mjs.map
