import { defineComponent, ref, unref, reactive, mergeProps, isRef, withCtx, createVNode, createTextVNode, resolveComponent, createBlock, createCommentVNode, openBlock, Fragment, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr } from 'vue/server-renderer';
import { a3 as useUserStore, _ as _export_sfc, E as ElInput, a as ElButton, aV as modifyInfoApi, b as ElMessage } from './server.mjs';
...
import { V as VerificationCode } from './VerificationCode-Clpjn_Tf.mjs';
  ...
  setup(__props, { expose: __expose }) {
    ...
    const sendCode = () => {
      ruleFormRef.value.validate((valid) => {
        ...
        if (!valid) return;
        try {
          (_a = verificationCodeRef.value) == null ? void 0 : _a.open();
        } catch (error) {
          console.log(error);
        }
      });
...
//# sourceMappingURL=profile-CkGeUGeA.mjs.map
