import { E as ElAutocomplete, g as getSearchCompletionApi } from './search-C8_J8OkW.mjs';
import { _ as _export_sfc, a2 as useNuxtApp, u as useRoute, a4 as useRouter, a8 as useAppStore, a3 as useUserStore, a9 as useCurrencyStore, a as ElButton, ac as __nuxt_component_1$2, ax as PRODUCT_URL, b as ElMessage } from './server.mjs';
  ...
  setup(__props) {
    ...
    const getProductBest = async () => {
      ...
      if (Object.keys(mutex).length) {
        initParam.categoryIds.push(((_a = mutex.config) == null ? void 0 : _a.referenceId) || mutex.id);
      }
      ...
      initParam.creatorId = ((_b = artistSelected.value.config) == null ? void 0 : _b.referenceId) || artistSelected.value.id || null;
      ...
      (_c = proListRef.value) == null ? void 0 : _c.search();
      isPopup.value = false;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(groupList), (group) => {
        ...
        if (((_b = group.config) == null ? void 0 : _b.type) === "GROUP") {
          ...
          ssrRenderList(group.children, (item) => {
            var _a2;
            _push(`<div class="${ssrRenderClass([{ on: ((_a2 = unref(groupSelected).get(item.parentId)) == null ? void 0 : _a2.id) === item.id }, "menu-item cursor-pointer my-20 line1"])}" data-v-4c6eb877>${ssrInterpolate(item.name)}</div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (((_d = group.config) == null ? void 0 : _d.type) === "RADIO") {
          ...
          ssrRenderList(group.children, (item) => {
            var _a2;
            _push(`<div class="acea-row row-between-wrapper py-20 border-t-sm border-b-sm cursor-pointer" data-v-4c6eb877><span class="text-16" data-v-4c6eb877>${ssrInterpolate(item.name)}</span><span class="${ssrRenderClass([[((_a2 = unref(radioSelected).get(item.parentId)) == null ? void 0 : _a2.id) === item.id ? "icon-check-fill text-primary" : "icon-check text-gray-400"], "iconfont text-18"])}" data-v-4c6eb877></span></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (((_e = group.config) == null ? void 0 : _e.type) === "CHECKBOX") {
          ...
          ssrRenderList(group.children, (item) => {
            var _a2;
            _push(`<div class="acea-row row-between-wrapper py-20 border-t-sm border-b-sm cursor-pointer" data-v-4c6eb877><span class="text-16" data-v-4c6eb877>${ssrInterpolate(item.name)}</span><span class="${ssrRenderClass([[((_a2 = unref(checkboxSelected).get(item.parentId)) == null ? void 0 : _a2.includes(item)) ? "icon-checkbox-fill text-primary" : "icon-checkbox text-gray-400"], "iconfont text-18"])}" data-v-4c6eb877></span></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (((_f = group.config) == null ? void 0 : _f.type) === "COLOR") {
          ...
          ssrRenderList(group.children, (item) => {
            var _a2, _b2;
            _push(`<div class="color-item acea-row row-middle cursor-pointer" data-v-4c6eb877><div class="${ssrRenderClass([{ "border-gray-700": (_a2 = unref(colorSelected)) == null ? void 0 : _a2.includes(item) }, "rounded-full border-sm p-2"])}" data-v-4c6eb877><div class="circle rounded-full" style="${ssrRenderStyle({ ...getColorStyle(item.config.color) })}" data-v-4c6eb877></div></div><div class="${ssrRenderClass([{ "f-bold": (_b2 = unref(colorSelected)) == null ? void 0 : _b2.includes(item) }, "pl-10 text-16 flex-1"])}" data-v-4c6eb877>${ssrInterpolate(item.name)}</div></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (((_g = group.config) == null ? void 0 : _g.type) === "ARTIST") {
          ...
          ssrRenderList(group.children, (item) => {
            var _a2;
            _push(`<div class="${ssrRenderClass([{ on: ((_a2 = unref(artistSelected)) == null ? void 0 : _a2.id) === item.id }, "menu-item cursor-pointer my-20"])}" data-v-4c6eb877>${ssrInterpolate(item.name)}</div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (((_b = group.config) == null ? void 0 : _b.type) === "GROUP") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a2, _b2;
              if (_push2) {
                _push2(`${ssrInterpolate(((_a2 = unref(groupSelected).get(group.id)) == null ? void 0 : _a2.name) || group.name)} <span class="iconfont icon-down text-16" data-v-4c6eb877${_scopeId}></span>`);
              } else {
                return [
        ...
        if (((_d = group.config) == null ? void 0 : _d.type) === "RADIO") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a2, _b2;
              if (_push2) {
                _push2(`${ssrInterpolate(((_a2 = unref(radioSubmitted).find((i) => i.parentId === group.id)) == null ? void 0 : _a2.name) || group.name)} <span class="iconfont icon-down text-16" data-v-4c6eb877${_scopeId}></span>`);
              } else {
                return [
        ...
        if (((_e = group.config) == null ? void 0 : _e.type) === "CHECKBOX") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a2, _b2;
              if (_push2) {
                _push2(`${ssrInterpolate(((_a2 = unref(checkboxSubmitted).find((i) => i.parentId === group.id)) == null ? void 0 : _a2.name) || group.name)} <span class="iconfont icon-down text-16" data-v-4c6eb877${_scopeId}></span>`);
              } else {
                return [
        ...
        if (((_f = group.config) == null ? void 0 : _f.type) === "COLOR") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a2, _b2;
              if (_push2) {
                _push2(`${ssrInterpolate(((_a2 = unref(colorSubmitted)[0]) == null ? void 0 : _a2.name) || group.name)} <span class="iconfont icon-down text-16" data-v-4c6eb877${_scopeId}></span>`);
              } else {
                return [
...
//# sourceMappingURL=product-DqeKVjqu.mjs.map
