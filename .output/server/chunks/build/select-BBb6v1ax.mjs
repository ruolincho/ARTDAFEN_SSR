import { defineComponent, withDirectives, createElementBlock, openBlock, normalizeClass, createElementVNode, toDisplayString, renderSlot, vShow, ref, getCurrentInstance, provide, reactive, toRefs, computed, withModifiers, unref, resolveComponent, resolveDirective, toHandlerKey, createVNode, withCtx, createCommentVNode, createBlock, Fragment, renderList, mergeProps, normalizeProps, normalizeStyle, createTextVNode, withKeys, vModelText, resolveDynamicComponent, watch, inject, toRaw, watchEffect, nextTick, shallowRef, isVNode } from 'vue';
import { E as ElTooltip, u as useTooltipContentProps } from './popper-BevOnpDk.mjs';
import { E as ElScrollbar, s as scrollbarEmits } from './scrollbar-BAU7-sWB.mjs';
import { E as ElTag, t as tagProps } from './index-TgbWtzhx.mjs';
import { w as withInstall, n as withNoopInstall, g as _export_sfc$1, e as useNamespace, c as buildProps, x as useId, U as UPDATE_MODEL_EVENT, C as CHANGE_EVENT, l as ElIcon, t as throwError, M as useAriaProps, N as useEmptyValuesProps, d as definePropType, O as arrow_down_default, j as iconPropType, P as circle_close_default, Q as useSizeProp, B as useLocale, D as useFormItem, F as useFormItemInputId, G as useEmptyValues, H as useComposition, I as useFocusController, r as debugWarn, V as ValidateComponentsMap, q as useFormSize, J as isUndefined, i as isNumber, R as flattedChildren, A as isElement, K as scrollIntoView, L as EVENT_CODE } from './server.mjs';
...
import { useMutationObserver, isIOS, isClient, useResizeObserver } from '@vueuse/core';
...
var OptionGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["render", _sfc_render$1], ["__file", "option-group.vue"]]);
...
var Select = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["render", _sfc_render], ["__file", "select.vue"]]);
...
//# sourceMappingURL=select-BBb6v1ax.mjs.map
