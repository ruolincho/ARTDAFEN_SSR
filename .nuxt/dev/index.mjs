...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutTrailingSlash, decodePath, withLeadingSlash, withoutProtocol, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/vue/index.mjs';
import { createHooks } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/youch-core/build/index.js';
import { Youch } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/errx/dist/index.js';
import devalue from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://F:/ArtProject/dafen-ui-ssr/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"F:/ArtProject/dafen-ui-ssr/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:/ArtProject/dafen-ui-ssr","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:/ArtProject/dafen-ui-ssr/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:/ArtProject/dafen-ui-ssr/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:/ArtProject/dafen-ui-ssr/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"F:/ArtProject/dafen-ui-ssr/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "siteUrl": "http://192.168.68.123:5174",
    "apiBase": "http://192.168.68.168:40000/api",
    "obsUrl": "https://dafen-test-media.obs.cn-south-1.myhuaweicloud.com",
    "paypalClientId": "AbxvpLu8klor2QTfCVOA1ZREmDWqG6zzejog1UjXSf_qL201R8Y5-8CMqfEthp6wxHBZbF2bBIVl9C20",
    "httpTimeout": "60000",
    "gaId": "G-ZYVS05RLZV"
  },
  "sitemap": {
  ...
  "nuxt-robots": {
    ...
    "sitemap": [
      "http://192.168.68.123:5174/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
const _FiSmONA4fsU3iyIwnTTP3G7XaknVePCvRKzlv4gQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "F:/ArtProject/dafen-ui-ssr";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"},{"charset":"utf-8"},{"name":"description","content":"Artdafen — the Dafen community's hub for the latest art news, gallery highlights, and creative resources. Explore pixel art showcases, installation art examples, and hands-on art & craft project ideas, plus curated drawing tutorials and inspiration from platforms like DeviantArt and ArtStation. Perfect for artists, students, and collectors seeking trends, techniques, and project-ready references."},{"name":"keywords","content":"ART DAFEN, ARTDAFEN art, artworks, contemporary art, gallery, sculpture, custom art, art workshops, Dafen, Dafen Oil Painting Village Shenzhen, oil paintingArtdafen, deviantart, arte, gallery, pixel art, draw, installation art examples, art and craft project ideas, drawing, artstation, drawings"},{"property":"og:type","content":"website"},{"property":"og:url","content":"http://192.168.68.123:5174"}],"link":[{"rel":"stylesheet","href":"https://fonts.font.im/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i"},{"rel":"icon","type":"image/svg+xml","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no","title":"ART DAFEN"};
...
const _ICnothkSPEq0RIOdW4mRs4wxYbyq8ZHoHmS0JCbUf8 = (nitroApp) => {
...
const _pIxVX3wna4KKaSTz6WkhZYyDkHAlAMMlz2oZXifFjM = defineNitroPlugin(async (nitroApp) => {
...
const _hc_RlKQxelBow7Ni4WTq2r6ZIdS7J8Dp1MQLCZcPX24 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _FiSmONA4fsU3iyIwnTTP3G7XaknVePCvRKzlv4gQ,
_ICnothkSPEq0RIOdW4mRs4wxYbyq8ZHoHmS0JCbUf8,
_pIxVX3wna4KKaSTz6WkhZYyDkHAlAMMlz2oZXifFjM,
_hc_RlKQxelBow7Ni4WTq2r6ZIdS7J8Dp1MQLCZcPX24
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2c00d-u5V8O9x45qFOQa4QjgZgklpVuqY\"",
    "mtime": "2025-09-12T03:52:23.889Z",
    "size": 180237,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"b054a-holAC17izNaXK29E8Y9TXIGK1EA\"",
    "mtime": "2025-09-12T03:52:23.890Z",
    "size": 722250,
    "path": "index.mjs.map"
  }
};
...
const _ZQXYk8 = eventHandler((event) => {
...
const _MQpmhA = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _AgCxtO = eventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://F:/ArtProject/dafen-ui-ssr/node_modules/fast-xml-parser/src/fxp.js');
...
const _ecMG9w = defineEventHandler(async (e) => {
...
const _Dv0rFJ = defineEventHandler(async (e) => {
...
const _i4B5pC = defineEventHandler(async (e) => {
...
const _lXkVZ1 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _9L6kDT = defineEventHandler(async (e) => {
...
const _2HDCuS = defineEventHandler(async (e) => {
...
const _zasmxw = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const getServerEntry = () => import('file://F:/ArtProject/dafen-ui-ssr/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://F:/ArtProject/dafen-ui-ssr/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_KBGLA2 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _ZQXYk8, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_KBGLA2, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _MQpmhA, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _AgCxtO, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _ecMG9w, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _Dv0rFJ, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _i4B5pC, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _lXkVZ1, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _9L6kDT, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _2HDCuS, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _zasmxw, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KBGLA2, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    ...
    },
    {
        ...
        "urls": [
            ...
            {
                "loc": "/account/payments"
            },
            {
                "loc": "/account/addresses"
            },
            {
                "loc": "/account/favorites"
            },
            {
                "loc": "/contact"
            },
