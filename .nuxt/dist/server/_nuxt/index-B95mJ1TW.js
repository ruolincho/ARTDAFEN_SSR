...
import { $ as $http, Z as TRADE_MODULE, a4 as useRouter, a as ElButton, aH as copyToClipboard, b as ElMessage, ab as imagePrefix, u as useRoute, a8 as useAppStore, a9 as useCurrencyStore, a3 as useUserStore, ap as useRuntimeConfig, aF as jumpToUrl, au as jumpToProduct, ax as PRODUCT_URL, aI as BEST_URL, _ as _export_sfc } from "../server.mjs";
import { defineComponent, ref, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, withAsyncContext, computed, resolveDirective, createBlock, createCommentVNode, openBlock, Fragment, withDirectives, vShow, renderList, withModifiers } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderAttrs, ssrGetDirectiveProps } from "vue/server-renderer";
import { Swiper, SwiperSlide } from "swiper/vue";
import { Autoplay, Pagination, Navigation } from "swiper";
/* empty css                        */
/* empty css                        */
import { g as gen_path_obj } from "./product-DJnmy_Y8.js";
import { a as subscribeForRealName } from "./message-DIUxZVmi.js";
...
const _imports_0 = "" + __buildAssetsURL("logo2.Fus64NH7.png");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_dialog, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center text-gray-700"${_scopeId}><p class="text-16 text-gray-600 f-bold-500"${_scopeId}>Exclusive Offer From:</p><img${ssrRenderAttr("src", _imports_0)} alt="logo" class="inline-block mt-20" style="${ssrRenderStyle({ "height": "46px" })}"${_scopeId}><p class="text-30 f-bold-500 my-20"${_scopeId}>Get ${ssrInterpolate(unref(couponDetail)?.discountRate)} off your order</p><p class="text-20 f-bold-500"${_scopeId}>${ssrInterpolate(unref(couponDetail)?.expire)} ${ssrInterpolate(unref(couponDetail)?.unit)} Only - ${ssrInterpolate(unref(couponDetail)?.startTime)} - ${ssrInterpolate(unref(couponDetail)?.endTime)} HKT</p><div class="acea-row row-between-wrapper border-sm border-dashed my-20 pl-22 pr-8 py-8 rounded-sm"${_scopeId}><span class="text-26 f-bold-500 text-uppercase line1 flex-1 text-left mr-10"${_scopeId}>${ssrInterpolate(unref(couponDetail)?.code)}</span>`);
            _push2(ssrRenderComponent(_component_el_button, {
              type: "primary",
              size: "large",
              onClick: ($event) => copyCode(unref(couponDetail)?.code)
            }, {
            ...
            return [
              createVNode("div", { class: "text-center text-gray-700" }, [
                ...
                createVNode("p", { class: "text-30 f-bold-500 my-20" }, "Get " + toDisplayString(unref(couponDetail)?.discountRate) + " off your order", 1),
                createVNode("p", { class: "text-20 f-bold-500" }, toDisplayString(unref(couponDetail)?.expire) + " " + toDisplayString(unref(couponDetail)?.unit) + " Only - " + toDisplayString(unref(couponDetail)?.startTime) + " - " + toDisplayString(unref(couponDetail)?.endTime) + " HKT", 1),
                createVNode("div", { class: "acea-row row-between-wrapper border-sm border-dashed my-20 pl-22 pr-8 py-8 rounded-sm" }, [
                  createVNode("span", { class: "text-26 f-bold-500 text-uppercase line1 flex-1 text-left mr-10" }, toDisplayString(unref(couponDetail)?.code), 1),
                ...
                if (_push3) {
                  ...
                  ssrRenderList(exploreData.value, (item) => {
                    _push3(ssrRenderComponent(unref(SwiperSlide), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="explore-item text-center border-sm border-gray-200 cursor-pointer select-none" data-v-db538c5d${_scopeId3}><div class="img-wrapper bg-gray-100" data-v-db538c5d${_scopeId3}><img${ssrRenderAttr("src", unref(imagePrefix)(item.img))} alt="" data-v-db538c5d${_scopeId3}></div><h1 class="mt-15 line1 px-10" data-v-db538c5d${_scopeId3}><span class="text-16 f-bold-500 text-underline" data-v-db538c5d${_scopeId3}>${ssrInterpolate(item.creator?.name)}</span><span class="iconfont icon-right text-16" data-v-db538c5d${_scopeId3}></span></h1><p class="line1 text-14 my-15 px-10" style="${ssrRenderStyle({ "word-break": "break-word" })}" data-v-db538c5d${_scopeId3}>${ssrInterpolate(item.title)}</p><p class="text-16 f-bold px-10 pb-10" data-v-db538c5d${_scopeId3}>${ssrInterpolate(unref(currencyStore).formatToCurrency(item.retailPrice))}</p></div>`);
                        } else {
                          return [
                            createVNode("div", {
                              ...
                              createVNode("h1", { class: "mt-15 line1 px-10" }, [
                                ...
                                }, toDisplayString(item.creator?.name), 9, ["onClick"]),
...
//# sourceMappingURL=index-B95mJ1TW.js.map
