import { _ as _export_sfc, a2 as useNuxtApp, a3 as useUserStore, a8 as useAppStore, aw as useCartStore, u as useRoute, a4 as useRouter, a9 as useCurrencyStore, ap as useRuntimeConfig, Z as TRADE_MODULE, b3 as cm2inch, ac as __nuxt_component_1$1, at as debounce, ab as imagePrefix, o as CONTACT_EMAIL, a as ElButton, b as ElMessage, ax as PRODUCT_URL } from "../server.mjs";
import { defineComponent, ref, computed, watch, toRaw, mergeProps, unref, useSSRContext, withAsyncContext, resolveDirective, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, withDirectives, vShow, isRef, Fragment, renderList, createTextVNode, nextTick } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderClass, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrGetDirectiveProps } from "vue/server-renderer";
...
import { g as getCombinationApi } from "./paint-B_vqKQsu.js";
import "swiper";
/* empty css                        */
/* empty css                        */
...
const _imports_0 = "" + __buildAssetsURL("quality1.BJZ2YJXc.png");
const _imports_1 = "" + __buildAssetsURL("quality2.DozYwGC6.png");
const _imports_2 = "" + __buildAssetsURL("quality3.BVn4quix.png");
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const getCombination = async (senior = false) => {
      ...
      if (!loaded) {
        ...
        if (hasMat.value) {
          ...
          chooseMatWidth(materialOptions.value[0].specs[0]?.matWidth || "");
        }
      }
      if (senior) {
    ...
    const frameMoney = computed(() => {
      const price = Number(currentFrameOption.value?.price) || 0;
      const surcharge = Number(currentFrameOption.value?.surcharge) || 0;
      if (!hasFrame.value) {
    ...
    const specs = computed(() => {
      ...
      const specs2 = {
        "Painting Size": currentSizeOption.value?.name,
        // 尺寸名称
        "Frame": !hasFrame.value ? currentFrameName : currentMaterialId.value === "" ? currentFrameName + ", " + innerFrame.value?.name : currentFrameName
        // 画框名称
      };
      if (hasFrame.value && !!currentMaterialId.value) {
        specs2["Mounting On"] = "Moisture Proof Backboard, Glass, Mat";
        specs2["Mat Color"] = currentMaterialOption.value?.name;
    ...
    return (_ctx, _push, _parent, _attrs) => {
                    ...
                    createVNode(_component_ClientOnly, null, {
                      default: withCtx(() => [
                        unref(goodsDetail).id ? (openBlock(), createBlock(_component_ImageGenerator, {
                          ...
                          "mat-color": unref(currentMaterialOption)?.config?.matColor || "",
                          "has-frame": unref(hasFrame),
                          "inner-frame": unref(isInnerFrame),
                          "embedded-frame": !unref(currentFrameOption)?.config?.matSupport,
                          "frame-cm": unref(currentFrameOption)?.config?.thickness,
                          "size-cm": {
                            width: Number(unref(currentSizeOption)?.widthInCm),
                            length: Number(unref(currentSizeOption)?.lengthInCm)
                          },
                          "frame-corner-images": [
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.lt),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.rt),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.lb),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.rb)
                          ],
                          "frame-side-images": [
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.ct),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.cb),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.cl),
                            unref(imagePrefix)(unref(currentFrameOption)?.config?.cr)
                          ],
      ...
      _push(ssrRenderComponent(_component_el_skeleton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="acea-row row-between-wrapper p-md-20 p-15" data-v-24101095${_scopeId}><div class="acea-row row-middle flex-1 mr-10" data-v-24101095${_scopeId}><span class="text-30 f-bold mr-md-20 mr-10 step-index" data-v-24101095${_scopeId}></span><span class="text-26" data-v-24101095${_scopeId}>Choose a Size</span><span class="text-26 text-gray-400 pc" data-v-24101095${_scopeId}>  (inches)</span></div><div class="text-20 f-bold" data-v-24101095${_scopeId}>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(currentSizeOption)?.price || 0))}</div></div><div class="p-md-20 p-15" data-v-24101095${_scopeId}>`);
              ...
              createVNode("div", { class: "spu-spec border-sm" }, [
                ...
                createVNode("div", { class: "acea-row row-between-wrapper p-md-20 p-15" }, [
                  createVNode("div", { class: "acea-row row-middle flex-1 mr-10" }, [
                    ...
                    createVNode("span", { class: "text-26 text-gray-400 pc" }, "  (inches)")
                  ]),
                  createVNode("div", { class: "text-20 f-bold" }, toDisplayString(unref(currencyStore).formatToCurrency(unref(currentSizeOption)?.price || 0)), 1)
                ]),
                createVNode("div", { class: "p-md-20 p-15" }, [
                ...
                createVNode("div", { class: "acea-row row-between-wrapper p-md-20 p-15" }, [
                  createVNode("div", { class: "acea-row row-middle flex-1 mr-10" }, [
                    ...
                    createVNode("span", { class: "text-26 text-gray-400 pc" }, "  (100+ styles)")
                  ]),
                ...
                unref(hasFrame) && unref(matVisible) ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                  createVNode("div", { class: "acea-row row-between-wrapper p-md-20 p-15" }, [
                    ...
                    createVNode("div", { class: "text-20 f-bold" }, toDisplayString(unref(currencyStore).formatToCurrency(unref(currentMaterialOption)?.price || 0)), 1)
                  ]),
                  createVNode("div", { class: "p-md-20 p-15" }, [
      ...
      if (unref(goodsDetail)?.brand?.id) {
        _push(`<section class="mt-lg-60 mt-sm-20" data-v-24101095><div class="container" data-v-24101095><div class="brand-topic mb-20" data-v-24101095><div class="brand-topic-caption text-white text-26" data-v-24101095><p data-v-24101095>${ssrInterpolate(unref(goodsDetail)?.brand?.name)}</p><p class="text-60 f-bold my-xs-20 my-15" data-v-24101095>${ssrInterpolate(unref(goodsDetail)?.brand?.title)}</p><p data-v-24101095>${ssrInterpolate(unref(goodsDetail)?.brand?.intro)}</p></div><button class="caption-btn text-28 p-xs-20 p-15" data-v-24101095> Brand Home <span class="iconfont icon-right-arrow text-28 ml-xs-60 ml-30" data-v-24101095></span></button><img class="w-full pc"${ssrRenderAttr("src", unref(imagePrefix)(unref(goodsDetail)?.brand?.background))} alt="" data-v-24101095><img class="w-full app"${ssrRenderAttr("src", unref(imagePrefix)(unref(goodsDetail)?.brand?.img))} alt="" data-v-24101095></div>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
        _push(`</div></section>`);
      } else {
        _push(`<!---->`);
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(shoppingFaq), (subItem) => {
              _push2(ssrRenderComponent(_component_el_collapse_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="px-20 py-24" data-v-24101095${_scopeId2}>${subItem.content ?? ""}</div>`);
                  } else {
                    return [
                      createVNode("div", {
                        class: "px-20 py-24",
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "acea-row row-between-wrapper text-gray-700 mb-10 py-20" }, [
                ...
                createVNode("span", { class: "text-14" }, toDisplayString(unref(currencyStore).formatToCurrency(unref(currentSizeOption)?.price || 0)), 1)
              ]),
              ...
              unref(hasFrame) && !!unref(currentMaterialId) ? (openBlock(), createBlock("div", {
                ...
                createVNode("span", { class: "text-14" }, toDisplayString(unref(currencyStore).formatToCurrency(unref(currentMaterialOption)?.price || 0)), 1)
              ])) : createCommentVNode("", true)
            ];
          }
        }),
...
//# sourceMappingURL=_id_-C2OF6vyX.js.map
