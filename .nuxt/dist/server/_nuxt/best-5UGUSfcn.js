import { $ as $http, Z as TRADE_MODULE, a2 as useNuxtApp, u as useRoute, a4 as useRouter, a8 as useAppStore, a3 as useUserStore, a9 as useCurrencyStore, a as ElButton, aa as vLoading, ab as imagePrefix, ac as __nuxt_component_1, b as ElMessage, _ as _export_sfc } from "../server.mjs";
  ...
  setup(__props) {
    ...
    const getProductBest = async () => {
      ...
      if (Object.keys(mutex).length) {
        categoryIds.push(mutex.config?.referenceId || mutex.id);
      }
      loading.value = true;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(groupList), (group) => {
        ...
        if (group.config?.type === "GROUP") {
          _push(`<!--[--><div class="my-24 pr-4 acea-row row-between-wrapper" data-v-fe1a7953><span class="text-20 f-bold flex-1" data-v-fe1a7953>${ssrInterpolate(group.name)}</span><span class="${ssrRenderClass([[group.isShow ? "icon-up" : "icon-down"], "text-18 cursor-pointer iconfont"])}" data-v-fe1a7953></span></div><div class="side-menu pr-4 border-t-lg border-b-lg border-primary" style="${ssrRenderStyle(group.isShow ? null : { display: "none" })}" data-v-fe1a7953><!--[-->`);
          ssrRenderList(group.children, (item) => {
            _push(`<div class="${ssrRenderClass([{ on: unref(groupSelected).get(item.parentId)?.id === item.id }, "menu-item cursor-pointer my-20 line1"])}" data-v-fe1a7953>${ssrInterpolate(item.name)}</div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (group.config?.type === "RADIO") {
          ...
          ssrRenderList(group.children, (item) => {
            _push(`<div class="acea-row row-between-wrapper py-20 border-t-sm border-b-sm cursor-pointer" data-v-fe1a7953><span class="text-16" data-v-fe1a7953>${ssrInterpolate(item.name)}</span><span class="${ssrRenderClass([[unref(radioSelected).get(item.parentId)?.id === item.id ? "icon-check-fill text-primary" : "icon-check text-gray-400"], "iconfont text-18"])}" data-v-fe1a7953></span></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (group.config?.type === "CHECKBOX") {
          ...
          ssrRenderList(group.children, (item) => {
            _push(`<div class="acea-row row-between-wrapper py-20 border-t-sm border-b-sm cursor-pointer" data-v-fe1a7953><span class="text-16" data-v-fe1a7953>${ssrInterpolate(item.name)}</span><span class="${ssrRenderClass([[unref(checkboxSelected).get(item.parentId)?.includes(item) ? "icon-checkbox-fill text-primary" : "icon-checkbox text-gray-400"], "iconfont text-18"])}" data-v-fe1a7953></span></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (group.config?.type === "COLOR") {
          ...
          ssrRenderList(group.children, (item) => {
            _push(`<div class="color-item acea-row row-middle cursor-pointer" data-v-fe1a7953><div class="${ssrRenderClass([{ "border-gray-700": unref(colorSelected)?.includes(item) }, "rounded-full border-sm p-2"])}" data-v-fe1a7953><div class="circle rounded-full" style="${ssrRenderStyle({ ...getColorStyle(item.config.color) })}" data-v-fe1a7953></div></div><div class="${ssrRenderClass([{ "f-bold": unref(colorSelected)?.includes(item) }, "pl-10 text-16 flex-1"])}" data-v-fe1a7953>${ssrInterpolate(item.name)}</div></div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
        ...
        if (group.config?.type === "ARTIST") {
          _push(`<!--[--><div class="my-24 pr-4 acea-row row-between-wrapper" data-v-fe1a7953><span class="text-20 f-bold flex-1" data-v-fe1a7953>${ssrInterpolate(group.name)}</span><span class="${ssrRenderClass([[group.isShow ? "icon-up" : "icon-down"], "text-18 cursor-pointer iconfont"])}" data-v-fe1a7953></span></div><div class="side-menu pr-4 border-t-lg border-b-lg border-primary" style="${ssrRenderStyle(group.isShow ? null : { display: "none" })}" data-v-fe1a7953><!--[-->`);
          ssrRenderList(group.children, (item) => {
            _push(`<div class="${ssrRenderClass([{ on: unref(artistSelected)?.id === item.id }, "menu-item cursor-pointer my-20"])}" data-v-fe1a7953>${ssrInterpolate(item.name)}</div>`);
          });
          _push(`<!--]--></div><!--]-->`);
        } else {
          _push(`<!---->`);
      ...
      ssrRenderList(unref(groupList), (group, index) => {
        ...
        if (group.config?.type === "GROUP") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(groupSelected).get(group.id)?.name || group.name)} <span class="iconfont icon-down text-16" data-v-fe1a7953${_scopeId}></span>`);
              } else {
                return [
        ...
        if (group.config?.type === "RADIO") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(radioSubmitted).find((i) => i.parentId === group.id)?.name || group.name)} <span class="iconfont icon-down text-16" data-v-fe1a7953${_scopeId}></span>`);
              } else {
                return [
        ...
        if (group.config?.type === "CHECKBOX") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(checkboxSubmitted).find((i) => i.parentId === group.id)?.name || group.name)} <span class="iconfont icon-down text-16" data-v-fe1a7953${_scopeId}></span>`);
              } else {
                return [
        ...
        if (group.config?.type === "COLOR") {
          _push(ssrRenderComponent(_component_el_tag, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(unref(colorSubmitted)[0]?.name || group.name)} <span class="iconfont icon-down text-16" data-v-fe1a7953${_scopeId}></span>`);
              } else {
                return [
      ...
      if (unref(productList).length) {
        ...
        ssrRenderList(unref(productList), (item, index) => {
          ...
          _push(`<div class="operation rounded-full p-5" data-v-fe1a7953><span class="iconfont icon-follow text-24 text-primary" style="${ssrRenderStyle(!item.like ? null : { display: "none" })}" data-v-fe1a7953></span><span class="iconfont icon-follow-fill text-24 text-error" style="${ssrRenderStyle(item.like ? null : { display: "none" })}" data-v-fe1a7953></span></div><div class="num acea-row row-center-wrapper text-20" data-v-fe1a7953>${ssrInterpolate(index + 1)}</div></div><div class="content-wrapper" data-v-fe1a7953><p class="my-8 line1" data-v-fe1a7953><span class="text-16 f-bold" data-v-fe1a7953>${ssrInterpolate(item.creator?.name)}</span><span class="iconfont icon-right text-16" data-v-fe1a7953></span></p><p class="line2 text-14" data-v-fe1a7953>${ssrInterpolate(item.title)}</p><p class="text-16 f-bold my-8" data-v-fe1a7953>${ssrInterpolate(unref(currencyStore).formatToCurrency(item.retailPrice))}</p><div class="acea-row gap-xs" data-v-fe1a7953><!--[-->`);
...
//# sourceMappingURL=best-5UGUSfcn.js.map
