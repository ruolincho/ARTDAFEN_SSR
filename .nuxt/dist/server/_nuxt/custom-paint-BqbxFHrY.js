import { i as isNumber, c as buildProps, d as definePropType, m as mutable, g as _export_sfc, aY as scale_to_original_default, aZ as full_screen_default, B as useLocale, e as useNamespace, S as useZIndex, T as ElFocusTrap, l as ElIcon, a1 as close_default, a_ as arrow_left_default, h as arrow_right_default, a$ as zoom_out_default, aS as zoom_in_default, b0 as refresh_left_default, b1 as refresh_right_default, b2 as keysOf, w as withInstall, a3 as useUserStore, a8 as useAppStore, u as useRoute, a4 as useRouter, a9 as useCurrencyStore, b3 as cm2inch, b4 as flattenTree, ab as imagePrefix, a as ElButton, ac as __nuxt_component_1, o as CONTACT_EMAIL, E as ElInput, b as ElMessage, b5 as getImageSize, b6 as calculateShape, _ as _export_sfc$1 } from "../server.mjs";
...
import { _ as _imports_4 } from "./logo-portrait-Bv-x2szr.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(currentThemeOption)?.children, (item) => {
      ...
      if (!unref(imageUrl)) {
        ...
        _push(`<div class="acea-row row-between-wrapper p-md-20 p-15" data-v-2ea98105><div class="acea-row row-middle" data-v-2ea98105><span class="text-30 f-bold mr-md-20 mr-10 step-index" data-v-2ea98105></span><span class="text-26" data-v-2ea98105>Choose a Size</span><span class="text-26 text-gray-400 pc" data-v-2ea98105>  (inches)</span></div><div class="text-20 f-bold" data-v-2ea98105>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(currentSizeOption)?.price || 0))}</div></div><div class="p-md-20 p-15" data-v-2ea98105>`);
        ...
        _push(`</div><div class="acea-row row-between-wrapper p-md-20 p-15" data-v-2ea98105><div class="acea-row row-middle" data-v-2ea98105><span class="text-30 f-bold mr-md-20 mr-10 step-index" data-v-2ea98105></span><span class="text-26" data-v-2ea98105>Choose a Frame</span><span class="text-26 text-gray-400 pc" data-v-2ea98105>  (100+ styles)</span></div><div class="text-20 f-bold" data-v-2ea98105>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(frameMoney) || 0))}</div></div><div class="p-md-20 p-15" data-v-2ea98105><div class="frame-scroll scroll-y border-sm p-10" data-v-2ea98105><div class="frame-list row" data-v-2ea98105><!--[-->`);
        ...
        if (unref(hasFrame) && unref(matVisible)) {
          _push(`<!--[--><div class="acea-row row-between-wrapper p-md-20 p-15" data-v-2ea98105><div class="acea-row row-middle" data-v-2ea98105><span class="text-30 f-bold mr-md-20 mr-10 step-index" data-v-2ea98105></span><span class="text-26" data-v-2ea98105>Choose a Canvas material</span></div><div class="text-20 f-bold" data-v-2ea98105>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(currentMaterialOption)?.price || 0))}</div></div><div class="p-md-20 p-15" data-v-2ea98105><div class="material-wrapper border-sm p-md-20 p-15" data-v-2ea98105><div class="acea-row row-middle text-20 f-bold-500" data-v-2ea98105><p class="mr-xl-40 mr-20" data-v-2ea98105>Mat Color</p><p class="flex-1 line1" data-v-2ea98105>Crisp Bright White</p></div><div class="color-list my-md-20 my-15" data-v-2ea98105><!--[-->`);
          ssrRenderList(unref(materialOptions), (item, index) => {
            _push(`<div class="${ssrRenderClass([{ on: unref(currentMaterialId) === item.id }, "color-item rounded-full cursor-pointer"])}" style="${ssrRenderStyle({ background: item.config?.matColor })}" data-v-2ea98105>`);
            if (item.id === "") {
      ...
      _push(ssrRenderComponent(_component_el_popover, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="acea-row row-between-wrapper text-gray-700 mb-10 py-20" data-v-2ea98105${_scopeId}><span class="f-bold text-18 flex-1 line1 mr-10" data-v-2ea98105${_scopeId}>Painting Size Price</span><span class="text-14" data-v-2ea98105${_scopeId}>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(currentSizeOption)?.price || 0))}</span></div><div class="acea-row row-between-wrapper text-gray-700 py-20 mb-10" data-v-2ea98105${_scopeId}><span class="f-bold text-18 flex-1 line1 mr-10" data-v-2ea98105${_scopeId}>Frame Price</span><span class="text-14" data-v-2ea98105${_scopeId}>${ssrInterpolate(unref(currencyStore).formatToCurrency(unref(frameMoney) || 0))}</span></div>`);
...
const customPaint = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-2ea98105"]]);
export {
  customPaint as default
};
//# sourceMappingURL=custom-paint-BqbxFHrY.js.map
