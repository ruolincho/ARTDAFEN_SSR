import { u as useRoute, a4 as useRouter, a9 as useCurrencyStore, ap as useRuntimeConfig, Z as TRADE_MODULE, ac as __nuxt_component_1, o as CONTACT_EMAIL, ab as imagePrefix, a as ElButton, _ as _export_sfc } from "../server.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(goodsDetail).creator) {
        _push(`<div class="row text-22" data-v-7c8a59e3><div class="col-3" data-v-7c8a59e3>Creator</div><div class="col-9" data-v-7c8a59e3><span class="text-underline cursor-pointer" data-v-7c8a59e3>${ssrInterpolate(unref(goodsDetail)?.creator?.name || "-")}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ...
      if (unref(goodsDetail).creator) {
        ...
        if (unref(goodsDetail)?.creator?.portrait) {
          _push(`<div class="avatar" data-v-7c8a59e3><img class="w-full"${ssrRenderAttr("src", unref(imagePrefix)(unref(goodsDetail)?.creator?.portrait))} alt="avatar" data-v-7c8a59e3></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="text-22 f-bold-500 my-20 text-underline cursor-pointer" data-v-7c8a59e3>${ssrInterpolate(unref(goodsDetail)?.creator?.name)}</p><p class="text-16 f-bold-500 my-20" data-v-7c8a59e3>${ssrInterpolate(unref(goodsDetail)?.creator?.region)}</p><p class="text-18" data-v-7c8a59e3>${ssrInterpolate(unref(goodsDetail)?.creator?.intro)}</p></div>`);
        if (unref(goodsDetail)?.creator?.detail) {
...
//# sourceMappingURL=_id_-C3j8IBRM.js.map
