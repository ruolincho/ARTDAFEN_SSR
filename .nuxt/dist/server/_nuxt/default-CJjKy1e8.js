import { _ as __nuxt_component_1$1 } from "./nuxt-link-DR_c-RpP.js";
import { a4 as useRouter, aw as useCartStore, a9 as useCurrencyStore, ab as imagePrefix, as as formatAttr, a as ElButton, ax as PRODUCT_URL, _ as _export_sfc, a8 as useAppStore, a3 as useUserStore, u as useRoute, ac as __nuxt_component_1$2, ap as useRuntimeConfig, Z as TRADE_MODULE, aI as BEST_URL, o as CONTACT_EMAIL } from "../server.mjs";
import { E as ElDivider } from "./divider-DgH3PmJB.js";
import { E as ElPopover } from "./popover-Z4OiMpEN.js";
import { defineComponent, mergeProps, unref, withCtx, createTextVNode, useSSRContext, ref, withAsyncContext, computed, resolveDirective, createVNode, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderStyle, ssrRenderSlot } from "vue/server-renderer";
import "./popper-BevOnpDk.js";
import { _ as _imports_0$1 } from "./logo-DzgOjlOk.js";
import "swiper";
/* empty css                        */
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(headerList), (menu, index) => {
        _push(`<div class="nav-item" data-v-7545298f><span class="${ssrRenderClass([{ "on": activeNavIndex.value === index || menu.path?.includes(currentRouteText.value) }, "nav-link cursor-pointer"])}" data-v-7545298f>${ssrInterpolate(menu.name)}</span></div>`);
      });
      ...
      ssrRenderList(unref(headerList), (menu, index) => {
        _push(`<li class="${ssrRenderClass([{ active: menu.path?.includes(currentRouteText.value), open: openIndex.value === index }, "P_parent"])}" data-v-7545298f><div class="cate-item" data-v-7545298f><div class="category-a" data-v-7545298f>${ssrInterpolate(menu.name)}</div>`);
...
const _imports_3 = "" + __buildAssetsURL("delivery-methods2.BUPgx6Lu.png");
const _imports_5 = "" + __buildAssetsURL("logo-footer.Dn55ZkbT.png");
...
//# sourceMappingURL=default-CJjKy1e8.js.map
