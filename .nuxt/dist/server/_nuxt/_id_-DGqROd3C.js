...
import { a9 as useCurrencyStore, u as useRoute, ap as useRuntimeConfig, Z as TRADE_MODULE, ab as imagePrefix, _ as _export_sfc } from "../server.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Swiper), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(blogDetail)?.banner, (item) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { key: item }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttrs(_temp0 = mergeProps({ alt: "" }, ssrGetDirectiveProps(_ctx, _directive_lazy, unref(imagePrefix)(item))))} data-v-531c4183${_scopeId2}>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : _temp0.innerHTML ?? ""}`);
                  } else {
                    return [
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(blogDetail)?.banner, (item) => {
      ...
      _push(`</div></div></section><section class="sec-content" data-v-531c4183><div class="container-small" data-v-531c4183><div class="interaction-container" data-v-531c4183><div class="author-container" data-v-531c4183><div class="text-30 f-bold my-20" data-v-531c4183>${ssrInterpolate(unref(blogDetail)?.title)}</div><div class="text-18" data-v-531c4183>${ssrInterpolate(unref(blogDetail)?.content)}</div>`);
      if (unref(blogDetail)?.labels?.length) {
      ...
      if (unref(blogDetail)?.products.length) {
...
//# sourceMappingURL=_id_-DGqROd3C.js.map
