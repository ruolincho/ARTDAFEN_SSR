import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, ref, computed, shallowRef, isReadonly, defineComponent, createElementBlock, provide, cloneVNode, h, isRef, isShallow, isReactive, toRaw, warn, unref, openBlock, normalizeClass, renderSlot, createVNode, Transition, withCtx, withDirectives, createElementVNode, normalizeStyle, createTextVNode, toDisplayString, vShow, mergeProps, watch, createBlock, createCommentVNode, resolveDynamicComponent, Fragment, withModifiers, nextTick, isVNode, render, useSlots, Text, useAttrs as useAttrs$1, onScopeDispose, resolveComponent, withKeys, markRaw, toRefs, createApp, defineAsyncComponent, Suspense, useSSRContext, onErrorCaptured, onServerPrefetch } from "vue";
import { $fetch as $fetch$1 } from "F:/artdafen-ui-ssr/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "F:/artdafen-ui-ssr/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "F:/artdafen-ui-ssr/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "F:/artdafen-ui-ssr/node_modules/h3/dist/index.mjs";
import { withQuery, hasProtocol, isScriptProtocol, joinURL } from "F:/artdafen-ui-ssr/node_modules/ufo/dist/index.mjs";
import { shouldHydrate, defineStore, createPinia, setActivePinia } from "pinia";
import { defu } from "F:/artdafen-ui-ssr/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "F:/artdafen-ui-ssr/node_modules/radix3/dist/index.mjs";
import { parse } from "F:/artdafen-ui-ssr/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "F:/artdafen-ui-ssr/node_modules/destr/dist/index.mjs";
import { isEqual } from "F:/artdafen-ui-ssr/node_modules/ohash/dist/index.mjs";
import { klona } from "F:/artdafen-ui-ssr/node_modules/klona/dist/index.mjs";
import { useSeoMeta as useSeoMeta$1, headSymbol, useHead as useHead$1 } from "F:/artdafen-ui-ssr/node_modules/@unhead/vue/dist/index.mjs";
import { isClient, useEventListener, useResizeObserver, useTimeoutFn, computedEager, useThrottleFn } from "@vueuse/core";
import { fromPairs, isNil, set, get, pick } from "lodash-unified";
import { isObject, hasOwn, isString, camelize, NOOP, isFunction, isArray, hyphenate } from "@vue/shared";
...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import("./_nuxt/faq-CyIoQ0Qh.js")
  },
  {
    name: "auth",
    path: "/auth",
    meta: __nuxt_page_meta$8 || {},
    component: () => import("./_nuxt/auth-6OtbYPrA.js")
  },
  {
    name: "best",
    path: "/best",
    component: () => import("./_nuxt/best-5UGUSfcn.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-CCSHw_r5.js")
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-42PbsIU3.js")
  },
  {
    name: "news",
    path: "/news",
    component: () => import("./_nuxt/news-yXeW6LIZ.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-B0KuYCFE.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B95mJ1TW.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-DbLLgbk1.js")
  },
  {
    name: "notice",
    path: "/notice",
    component: () => import("./_nuxt/notice-BW2lAGsU.js")
  },
  {
    name: "search",
    path: "/search",
    meta: __nuxt_page_meta$7 || {},
    component: () => import("./_nuxt/search-CSn7MGpu.js")
  },
  {
    name: __nuxt_page_meta$1?.name,
    path: "/account",
    component: () => import("./_nuxt/account-Dk0vAFS0.js"),
    children: [
      {
        name: "account",
        path: "",
        redirect: "/account/profile",
        component: () => import("./_nuxt/index-BZotmIbP.js")
      },
      {
        name: "account-orders",
        path: "orders",
        meta: __nuxt_page_meta$6 || {},
        component: () => import("./_nuxt/orders-BUh2o3Lh.js")
      },
      {
        name: "account-profile",
        path: "profile",
        meta: __nuxt_page_meta$5 || {},
        component: () => import("./_nuxt/profile-CkGeUGeA.js")
      },
      {
        name: "account-payments",
        path: "payments",
        meta: __nuxt_page_meta$4 || {},
        component: () => import("./_nuxt/payments-B8DQSuby.js")
      },
      {
        name: "account-addresses",
        path: "addresses",
        meta: __nuxt_page_meta$3 || {},
        component: () => import("./_nuxt/addresses-D4nGwBlK.js")
      },
      {
        name: "account-favorites",
        path: "favorites",
        meta: __nuxt_page_meta$2 || {},
        component: () => import("./_nuxt/favorites-DEr9aQHQ.js")
      }
    ]
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BWJ6EeXP.js")
  },
  {
    name: "product",
    path: "/product",
    component: () => import("./_nuxt/product-DqeKVjqu.js")
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-DOSaFFbk.js")
  },
  {
    name: "artists-all",
    path: "/artists-all",
    component: () => import("./_nuxt/artists-all-UvhE7L3A.js")
  },
  {
    name: "artists-top",
    path: "/artists-top",
    component: () => import("./_nuxt/artists-top-G-D6EVX1.js")
  },
  {
    name: "custom-paint",
    path: "/custom-paint",
    component: () => import("./_nuxt/custom-paint-BqbxFHrY.js")
  },
  {
    name: "artists-brief",
    path: "/artists-brief",
    component: () => import("./_nuxt/artists-brief-DhLAe6FZ.js")
  },
  {
    name: "collaboration",
    path: "/collaboration",
    component: () => import("./_nuxt/collaboration-D1uywP9n.js")
  },
  {
    name: "cookies-policy",
    path: "/cookies-policy",
    component: () => import("./_nuxt/cookies-policy-l-R0xhJx.js")
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import("./_nuxt/privacy-policy-Dk7S0uU5.js")
  },
  {
    name: "checkout-custom",
    path: "/checkout-custom",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/checkout-custom-DiEPNleu.js")
  },
  {
    name: "forget-password",
    path: "/forget-password",
    component: () => import("./_nuxt/forget-password-DyrY8_B2.js")
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
    component: () => import("./_nuxt/_id_-DGqROd3C.js")
  },
  {
    name: "news-detail-id",
    path: "/news-detail/:id()",
    component: () => import("./_nuxt/_id_-DX0-3ts8.js")
  },
  {
    name: "spot-detail-id",
    path: "/spot-detail/:id()",
    component: () => import("./_nuxt/_id_-BFtBuFic.js")
  },
  {
    name: "order-detail-id",
    path: "/order-detail/:id()",
    component: () => import("./_nuxt/_id_-Dx1MNV0S.js")
  },
  {
    name: "paint-detail-id",
    path: "/paint-detail/:id()",
    component: () => import("./_nuxt/_id_-C2OF6vyX.js")
  },
  {
    name: "artist-detail-id",
    path: "/artist-detail/:id()",
    component: () => import("./_nuxt/_id_-Vshplt_p.js")
  },
  {
    name: "original-detail-id",
    path: "/original-detail/:id()",
    component: () => import("./_nuxt/_id_-C3j8IBRM.js")
  },
  {
    name: "terms-and-conditions",
    path: "/terms-and-conditions",
    component: () => import("./_nuxt/terms-and-conditions-Zm9JfWBK.js")
  }
];
...
const layouts = {
  blank: defineAsyncComponent(() => import("./_nuxt/blank-WgUNCEKn.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-CJjKy1e8.js").then((m) => m.default || m))
};
...
export {
  ...
  useEmptyValues as G,
  useComposition as H,
  useFocusController as I,
  isUndefined as J,
  scrollIntoView as K,
  EVENT_CODE as L,
  useAriaProps as M,
  useEmptyValuesProps as N,
  arrow_down_default as O,
  circle_close_default as P,
  useSizeProp as Q,
  flattedChildren as R,
  useZIndex as S,
  ElFocusTrap as T,
  ...
  buildProp as W,
  focusElement as X,
  useGetDerivedNamespace as Y,
  TRADE_MODULE as Z,
  _export_sfc as _,
  ElButton as a,
  zoom_out_default as a$,
  USER_MODULE as a0,
  close_default as a1,
  useNuxtApp as a2,
  useUserStore as a3,
  useRouter as a4,
  STORAGE_BACK_URL as a5,
  HOME_URL as a6,
  piniaPersistConfig as a7,
  useAppStore as a8,
  useCurrencyStore as a9,
  useFormDisabled as aA,
  minus_default as aB,
  arrow_up_default as aC,
  plus_default as aD,
  isPropAbsent as aE,
  jumpToUrl as aF,
  picture_filled_default as aG,
  copyToClipboard as aH,
  BEST_URL as aI,
  asyncDataDefaults as aJ,
  createError as aK,
  inputProps as aL,
  loading_default as aM,
  __nuxt_component_1 as aN,
  warning_filled_default as aO,
  circle_check_default as aP,
  check_default as aQ,
  document_default as aR,
  zoom_in_default as aS,
  delete_default as aT,
  entriesOf as aU,
  modifyInfoApi as aV,
  ElMessageBox as aW,
  getHomeArtistsApi as aX,
  scale_to_original_default as aY,
  full_screen_default as aZ,
  arrow_left_default as a_,
  vLoading as aa,
  imagePrefix as ab,
  __nuxt_component_1$2 as ac,
  withInstallDirective as ad,
  LOGIN_URL as ae,
  FOCUS_TRAP_INJECTION_KEY as af,
  useDraggable as ag,
  CloseComponents as ah,
  useGlobalConfig as ai,
  defaultNamespace as aj,
  useLockscreen as ak,
  useDeprecated as al,
  ElOverlay as am,
  useSameTarget as an,
  resolveRouteObject as ao,
  useRuntimeConfig as ap,
  navigateTo as aq,
  nuxtLinkDefaults as ar,
  formatAttr as as,
  debounce as at,
  jumpToProduct as au,
  jumpNewWindow as av,
  useCartStore as aw,
  PRODUCT_URL as ax,
  confirmOrderApi as ay,
  INPUT_EVENT as az,
  ElMessage as b,
  refresh_left_default as b0,
  refresh_right_default as b1,
  keysOf as b2,
  cm2inch as b3,
  flattenTree as b4,
  getImageSize as b5,
  calculateShape as b6,
  dataURLtoBlob as b7,
  buildProps as c,
  definePropType as d,
  entry$1 as default,
